...
function ifLost(){
	...
	if(wrong <= guessedLetters.length - correctCounter){
		wrong = guessedLetters.length - correctCounter;
	}
...
function keyPress(){
	...
	var remainingAttempts = attempts - wrong;
	document.getElementById("wrong").textContent = "Remaining incorrect attempts: " + remainingAttempts;
}
